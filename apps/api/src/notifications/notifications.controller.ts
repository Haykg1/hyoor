...
export class NotificationsController {
  ...
  markRead(@Param('id') id: string, @CurrentUser() user: RequestUser): Promise<NotificationItem> {
  ...
  @ApiOkResponse({ description: 'Updated notification' })
  @ApiStandardErrors({ notFound: true })
  markUnread(@Param('id') id: string, @CurrentUser() user: RequestUser): Promise<NotificationItem> {
